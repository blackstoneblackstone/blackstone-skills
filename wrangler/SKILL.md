---
name: wrangler
description: Cloudflare Workers CLI for deploying, developing, and managing Workers, KV, R2, D1, Vectorize, Hyperdrive, Workers AI, Containers, Queues, Workflows, Pipelines, and Secrets Store. Use when working with Cloudflare Workers, wrangler CLI commands, or deploying to Cloudflare edge infrastructure.
---
